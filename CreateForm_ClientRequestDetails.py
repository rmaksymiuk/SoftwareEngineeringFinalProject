...
AutogeneratedNumber = wsNumber['B3'].value + 1
wsNumber['B3'].value = AutogeneratedNumber
wbNumber.save('Applications/NewestFormNumber.xlsx')

# Create a new file based on the template, input the generated case ID
wb= load_workbook('Applications/ClientRequestDetails.xlsx')
ws = wb.active
ws['A2'].value = AutogeneratedNumber
print(ws['A2'].value)
dest_filename = 'Applications/ClientRequestDetails' + str(AutogeneratedNumber) + '.xlsx'
